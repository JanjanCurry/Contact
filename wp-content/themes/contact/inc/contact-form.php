<form id="sunsetContactForm" class="sunset-contact-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
	...
	<div class="form-group">
		<input type="text" class="form-control sunset-form-control" placeholder="Your number" id="number" name="number">
		<small class="text-danger form-control-msg">Your Number is Required</small>
	</div>
